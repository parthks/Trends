export const AI_PROMPTS = {
  ...
  ANALYZE_TWEET: {
    prompt:
      "Analyze the tweet and return a the key highlight of the tweet. This summary will be used as a long term memory for an LLM. The summary should be concise and to the point. Be sure to include all relevant details. Only output the key highlight, no introduction like Here is the key highlight of the tweet or any fluff or extra words should be used. ",
    systemPrompt:
